...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v3_stocks__warehouseId__put_request_stocks_inner")]
    public partial class ApiV3StocksWarehouseIdPutRequestStocksInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV3StocksWarehouseIdPutRequestStocksInner" /> class.
        /// </summary>
        /// <param name="sku">Баркод.</param>
        /// <param name="amount">Остаток.</param>
        public ApiV3StocksWarehouseIdPutRequestStocksInner(string sku = default(string), int amount = default(int))
        {
            this.Sku = sku;
            this.Amount = amount;
        }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV3StocksWarehouseIdPutRequestStocksInner {\n");
        ...
        {
            // Amount (int) maximum
            if (this.Amount > (int)100000)
            {
                yield return new ValidationResult("Invalid value for Amount, must be a value less than or equal to 100000.", new [] { "Amount" });
            }

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseIncorrectDate")]
    public partial class ResponseIncorrectDate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseIncorrectDate" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ResponseIncorrectDate(string error = default(string))
        {
            this.Error = error;
        }

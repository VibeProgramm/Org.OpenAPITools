...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ResponseError : IValidatableObject
    {
        /// <summary>
        ...
        public ResponseError(Object data = default(Object), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;

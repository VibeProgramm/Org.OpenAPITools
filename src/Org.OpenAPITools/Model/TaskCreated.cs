...
namespace Org.OpenAPITools.Model
{
    ...
    /// TaskCreated
    /// </summary>
    [DataContract(Name = "TaskCreated")]
    public partial class TaskCreated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCreated" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        public TaskCreated(TaskCreatedData data = default(TaskCreatedData), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public TaskCreatedData Data { get; set; }

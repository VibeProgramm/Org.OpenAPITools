...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_history_tasks_get_400_response")]
    public partial class ApiV2HistoryTasksGet400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2HistoryTasksGet400Response" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">error.</param>
        /// <param name="errorText">errorText.</param>
        public ApiV2HistoryTasksGet400Response(Object data = default(Object), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        */
        ...
        /// </summary>
        /*
        <example>Invalid query params</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2HistoryTasksGet400Response {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// ClubDiscReq
    /// </summary>
    [DataContract(Name = "ClubDiscReq")]
    public partial class ClubDiscReq : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClubDiscReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClubDiscReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClubDiscReq" /> class.
        /// </summary>
        /// <param name="nmID">Артикул WB (required).</param>
        /// <param name="clubDiscount">Скидка WB Клуба, % (required).</param>
        public ClubDiscReq(int nmID = default(int), int clubDiscount = default(int))
        {
            this.NmID = nmID;
        ...
        */
        ...
        <example>5</example>
        */
        [DataMember(Name = "clubDiscount", IsRequired = true, EmitDefaultValue = true)]

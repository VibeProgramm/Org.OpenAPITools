...
namespace Org.OpenAPITools.Model
{
    ...
    /// Настройки
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_trash_post_request_settings")]
    public partial class ContentV2GetCardsTrashPostRequestSettings : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsTrashPostRequestSettings" /> class.
        /// </summary>
        /// <param name="sort">sort.</param>
        /// <param name="cursor">cursor.</param>
        /// <param name="filter">filter.</param>
        public ContentV2GetCardsTrashPostRequestSettings(ContentV2GetCardsTrashPostRequestSettingsSort sort = default(ContentV2GetCardsTrashPostRequestSettingsSort), ContentV2GetCardsTrashPostRequestSettingsCursor cursor = default(ContentV2GetCardsTrashPostRequestSettingsCursor), ContentV2GetCardsTrashPostRequestSettingsFilter filter = default(ContentV2GetCardsTrashPostRequestSettingsFilter))
        {
            this.Sort = sort;
            this.Cursor = cursor;
            this.Filter = filter;
        ...
        public ContentV2GetCardsTrashPostRequestSettingsSort Sort { get; set; }

        /// <summary>
        /// Gets or Sets Cursor
        /// </summary>
        [DataMember(Name = "cursor", EmitDefaultValue = false)]
        public ContentV2GetCardsTrashPostRequestSettingsCursor Cursor { get; set; }

        /// <summary>
        /// Gets or Sets Filter
        /// </summary>
        [DataMember(Name = "filter", EmitDefaultValue = false)]
        public ContentV2GetCardsTrashPostRequestSettingsFilter Filter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsTrashPostRequestSettings {\n");

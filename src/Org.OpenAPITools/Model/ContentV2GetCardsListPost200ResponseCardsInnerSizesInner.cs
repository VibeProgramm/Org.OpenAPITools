...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_list_post_200_response_cards_inner_sizes_inner")]
    public partial class ContentV2GetCardsListPost200ResponseCardsInnerSizesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsListPost200ResponseCardsInnerSizesInner" /> class.
        /// </summary>
        /// <param name="chrtID">Числовой ID размера для данного артикула WB.</param>
        /// <param name="techSize">Размер товара (А, XXL, 57 и др.).</param>
        /// <param name="wbSize">Российский размер товара.</param>
        /// <param name="skus">Баркод товара.</param>
        public ContentV2GetCardsListPost200ResponseCardsInnerSizesInner(int chrtID = default(int), string techSize = default(string), string wbSize = default(string), List<string> skus = default(List<string>))
        {
            this.ChrtID = chrtID;
        ...
        /// </summary>
        /// <value>Числовой ID размера для данного артикула WB</value>
        ...
        /// </summary>
        /// <value>Размер товара (А, XXL, 57 и др.)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsListPost200ResponseCardsInnerSizesInner {\n");

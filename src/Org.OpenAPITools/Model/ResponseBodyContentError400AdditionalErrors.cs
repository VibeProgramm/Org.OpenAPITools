...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseBodyContentError400_additionalErrors")]
    public partial class ResponseBodyContentError400AdditionalErrors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseBodyContentError400AdditionalErrors" /> class.
        /// </summary>
        /// <param name="moveNmsToTrash">moveNmsToTrash.</param>
        public ResponseBodyContentError400AdditionalErrors(string moveNmsToTrash = default(string))
        {
            this.MoveNmsToTrash = moveNmsToTrash;
        }

        /// <summary>
        /// Gets or Sets MoveNmsToTrash
        /// </summary>
        [DataMember(Name = "MoveNmsToTrash", EmitDefaultValue = false)]
        public string MoveNmsToTrash { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MoveNmsToTrash: ").Append(MoveNmsToTrash).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }

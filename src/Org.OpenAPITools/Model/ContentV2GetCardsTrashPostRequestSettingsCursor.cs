...
namespace Org.OpenAPITools.Model
{
    ...
    /// Курсор
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_trash_post_request_settings_cursor")]
    public partial class ContentV2GetCardsTrashPostRequestSettingsCursor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsTrashPostRequestSettingsCursor" /> class.
        /// </summary>
        /// <param name="limit">Сколько карточек товаров выдать в ответе.</param>
        public ContentV2GetCardsTrashPostRequestSettingsCursor(int limit = default(int))
        {
            this.Limit = limit;
        }
        ...
        /// </summary>
        /// <value>Сколько карточек товаров выдать в ответе</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsTrashPostRequestSettingsCursor {\n");

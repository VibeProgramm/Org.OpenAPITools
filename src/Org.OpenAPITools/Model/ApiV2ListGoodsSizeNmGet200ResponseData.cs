...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_list_goods_size_nm_get_200_response_data")]
    public partial class ApiV2ListGoodsSizeNmGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ListGoodsSizeNmGet200ResponseData" /> class.
        /// </summary>
        /// <param name="listGoods">Размеры товара.</param>
        public ApiV2ListGoodsSizeNmGet200ResponseData(List<SizeGood> listGoods = default(List<SizeGood>))
        {
        ...
        public List<SizeGood> ListGoods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2ListGoodsSizeNmGet200ResponseData {\n");

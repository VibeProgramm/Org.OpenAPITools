...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_cards_upload_post_request_inner_variants_inner_sizes_inner")]
    public partial class ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner" /> class.
        /// </summary>
        /// <param name="techSize">Размер товара (XL, 45 и др.).</param>
        /// <param name="wbSize">Российский размер товара.</param>
        /// <param name="price">Цена товара.</param>
        /// <param name="skus">Баркод. Если не указать, сгенерируется системой автоматически..</param>
        public ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner(string techSize = default(string), string wbSize = default(string), int price = default(int), List<string> skus = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Размер товара (XL, 45 и др.)</value>
        ...
        /// </summary>
        /// <value>Баркод. Если не указать, сгенерируется системой автоматически.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2CardsUploadPostRequestInnerVariantsInnerSizesInner {\n");

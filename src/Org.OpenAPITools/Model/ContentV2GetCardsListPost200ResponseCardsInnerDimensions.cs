...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_list_post_200_response_cards_inner_dimensions")]
    public partial class ContentV2GetCardsListPost200ResponseCardsInnerDimensions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsListPost200ResponseCardsInnerDimensions" /> class.
        /// </summary>
        ...
        public ContentV2GetCardsListPost200ResponseCardsInnerDimensions(int length = default(int), int width = default(int), int height = default(int), bool isValid = default(bool))
        {
            this.Length = length;
            this.Width = width;
            this.Height = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsListPost200ResponseCardsInnerDimensions {\n");

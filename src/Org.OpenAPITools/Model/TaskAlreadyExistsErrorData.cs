...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskAlreadyExistsError_data")]
    public partial class TaskAlreadyExistsErrorData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAlreadyExistsErrorData" /> class.
        /// </summary>
        /// <param name="id">ID загрузки.</param>
        /// <param name="alreadyExists">Флаг дублирования загрузки: &#x60;true&#x60; — такая загрузка уже есть .</param>
        public TaskAlreadyExistsErrorData(int id = default(int), bool alreadyExists = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskAlreadyExistsErrorData {\n");

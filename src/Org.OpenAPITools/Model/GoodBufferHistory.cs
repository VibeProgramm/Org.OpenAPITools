...
namespace Org.OpenAPITools.Model
{
    ...
    /// GoodBufferHistory
    /// </summary>
    [DataContract(Name = "GoodBufferHistory")]
    public partial class GoodBufferHistory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GoodBufferHistory" /> class.
        /// </summary>
        ...
        /// <param name="status">Статус товара: &#x60;1&#x60; — в обработке .</param>
        /// <param name="errorText">Текст ошибки.</param>
        public GoodBufferHistory(int nmID = default(int), string vendorCode = default(string), int sizeID = default(int), string techSizeName = default(string), int price = default(int), string currencyIsoCode4217 = default(string), int discount = default(int), int clubDiscount = default(int), int status = default(int), string errorText = default(string))
        {
            this.NmID = nmID;
        ...
        */
        ...
        /// </summary>
        /// <value>Статус товара: &#x60;1&#x60; — в обработке </value>
        /*
        <example>1</example>
        */

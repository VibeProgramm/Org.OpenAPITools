...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_buffer_goods_task_get_200_response_data")]
    public partial class ApiV2BufferGoodsTaskGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2BufferGoodsTaskGet200ResponseData" /> class.
        /// </summary>
        /// <param name="uploadID">ID загрузки.</param>
        /// <param name="bufferGoods">Информация о товарах в загрузке.</param>
        public ApiV2BufferGoodsTaskGet200ResponseData(int uploadID = default(int), List<GoodBufferHistory> bufferGoods = default(List<GoodBufferHistory>))
        {
        ...
        */
        ...
        [DataMember(Name = "bufferGoods", EmitDefaultValue = false)]
        public List<GoodBufferHistory> BufferGoods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2BufferGoodsTaskGet200ResponseData {\n");
            sb.Append("  UploadID: ").Append(UploadID).Append("\n");
            sb.Append("  BufferGoods: ").Append(BufferGoods).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }

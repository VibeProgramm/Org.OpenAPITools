...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v3_warehouses_post_201_response")]
    public partial class ApiV3WarehousesPost201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV3WarehousesPost201Response" /> class.
        /// </summary>
        /// <param name="id">ID склада продавца.</param>
        public ApiV3WarehousesPost201Response(int id = default(int))
        {
            this.Id = id;
        }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV3WarehousesPost201Response {\n");

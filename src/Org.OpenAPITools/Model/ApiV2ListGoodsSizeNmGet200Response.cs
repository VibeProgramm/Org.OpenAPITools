...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_list_goods_size_nm_get_200_response")]
    public partial class ApiV2ListGoodsSizeNmGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2ListGoodsSizeNmGet200Response" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        public ApiV2ListGoodsSizeNmGet200Response(ApiV2ListGoodsSizeNmGet200ResponseData data = default(ApiV2ListGoodsSizeNmGet200ResponseData), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public ApiV2ListGoodsSizeNmGet200ResponseData Data { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2ListGoodsSizeNmGet200Response {\n");

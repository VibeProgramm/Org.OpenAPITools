...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_list_post_request")]
    public partial class ContentV2GetCardsListPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsListPostRequest" /> class.
        /// </summary>
        /// <param name="settings">settings.</param>
        public ContentV2GetCardsListPostRequest(ContentV2GetCardsListPostRequestSettings settings = default(ContentV2GetCardsListPostRequestSettings))
        {
        ...
        public ContentV2GetCardsListPostRequestSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsListPostRequest {\n");

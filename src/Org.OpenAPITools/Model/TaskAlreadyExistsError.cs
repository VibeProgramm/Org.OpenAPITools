...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskAlreadyExistsError")]
    public partial class TaskAlreadyExistsError : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAlreadyExistsError" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        public TaskAlreadyExistsError(TaskAlreadyExistsErrorData data = default(TaskAlreadyExistsErrorData), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public TaskAlreadyExistsErrorData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskAlreadyExistsError {\n");

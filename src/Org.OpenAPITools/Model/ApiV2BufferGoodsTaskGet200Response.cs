...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_buffer_goods_task_get_200_response")]
    public partial class ApiV2BufferGoodsTaskGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2BufferGoodsTaskGet200Response" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        public ApiV2BufferGoodsTaskGet200Response(ApiV2BufferGoodsTaskGet200ResponseData data = default(ApiV2BufferGoodsTaskGet200ResponseData), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public ApiV2BufferGoodsTaskGet200ResponseData Data { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2BufferGoodsTaskGet200Response {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_upload_task_size_post_request")]
    public partial class ApiV2UploadTaskSizePostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2UploadTaskSizePostRequest" /> class.
        /// </summary>
        /// <param name="data">Размеры и цены для них. Максимум 1 000 размеров. &lt;br&gt;&lt;br&gt; Для товаров с поразмерной установкой цен карантин не применяется .</param>
        public ApiV2UploadTaskSizePostRequest(List<SizeGoodReq> data = default(List<SizeGoodReq>))
        {
            this.Data = data;
        }
        ...
        /// </summary>
        /// <value>Размеры и цены для них. Максимум 1 000 размеров. &lt;br&gt;&lt;br&gt; Для товаров с поразмерной установкой цен карантин не применяется </value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<SizeGoodReq> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2UploadTaskSizePostRequest {\n");

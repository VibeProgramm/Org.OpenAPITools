...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseContentError6")]
    public partial class ResponseContentError6 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseContentError6" /> class.
        /// </summary>
        ...
        public ResponseContentError6(Object data = default(Object), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseContentError6 {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_cards_update_post_413_response")]
    public partial class ContentV2CardsUpdatePost413Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2CardsUpdatePost413Response" /> class.
        /// </summary>
        ...
        public ContentV2CardsUpdatePost413Response(string title = default(string), string detail = default(string), string code = default(string), string requestId = default(string), string origin = default(string), decimal status = default(decimal), string statusText = default(string))
        {
            this.Title = title;
            this.Detail = detail;
            this.Code = code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2CardsUpdatePost413Response {\n");

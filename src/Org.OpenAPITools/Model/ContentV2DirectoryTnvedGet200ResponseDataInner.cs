...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_directory_tnved_get_200_response_data_inner")]
    public partial class ContentV2DirectoryTnvedGet200ResponseDataInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2DirectoryTnvedGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="tnved">ТНВЭД-код.</param>
        /// <param name="isKiz">- &#x60;true&#x60; - код маркировки требуется - &#x60;false&#x60; - код маркировки не требуется .</param>
        public ContentV2DirectoryTnvedGet200ResponseDataInner(string tnved = default(string), bool isKiz = default(bool))
        {
            this.Tnved = tnved;
            this.IsKiz = isKiz;
        }
        ...
        /// </summary>
        /// <value>- &#x60;true&#x60; - код маркировки требуется - &#x60;false&#x60; - код маркировки не требуется </value>
        [DataMember(Name = "isKiz", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2DirectoryTnvedGet200ResponseDataInner {\n");
            sb.Append("  Tnved: ").Append(Tnved).Append("\n");
            sb.Append("  IsKiz: ").Append(IsKiz).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }

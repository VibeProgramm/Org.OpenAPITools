...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_quarantine_goods_get_200_response_data")]
    public partial class ApiV2QuarantineGoodsGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2QuarantineGoodsGet200ResponseData" /> class.
        /// </summary>
        /// <param name="quarantineGoods">Информация о товарах в карантине.</param>
        public ApiV2QuarantineGoodsGet200ResponseData(List<QuarantineGoods> quarantineGoods = default(List<QuarantineGoods>))
        {
        ...
        /// </summary>
        /// <value>Информация о товарах в карантине</value>
        [DataMember(Name = "quarantineGoods", EmitDefaultValue = false)]
        public List<QuarantineGoods> QuarantineGoods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2QuarantineGoodsGet200ResponseData {\n");
            sb.Append("  QuarantineGoods: ").Append(QuarantineGoods).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseCardCreate_additionalErrors_oneOf")]
    public partial class ResponseCardCreateAdditionalErrorsOneOf : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseCardCreateAdditionalErrorsOneOf" /> class.
        /// </summary>
        /// <param name="varString">varString.</param>
        public ResponseCardCreateAdditionalErrorsOneOf(string varString = default(string))
        {

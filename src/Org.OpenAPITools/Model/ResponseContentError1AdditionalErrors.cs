...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseContentError1_additionalErrors")]
    public partial class ResponseContentError1AdditionalErrors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseContentError1AdditionalErrors" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ResponseContentError1AdditionalErrors(string error = default(string))
        {
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResponseContentError1AdditionalErrors {\n");

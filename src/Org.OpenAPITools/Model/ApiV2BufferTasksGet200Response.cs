...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v2_buffer_tasks_get_200_response")]
    public partial class ApiV2BufferTasksGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV2BufferTasksGet200Response" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        public ApiV2BufferTasksGet200Response(SupplierTaskMetadataBuffer data = default(SupplierTaskMetadataBuffer), bool error = default(bool), string errorText = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public SupplierTaskMetadataBuffer Data { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV2BufferTasksGet200Response {\n");

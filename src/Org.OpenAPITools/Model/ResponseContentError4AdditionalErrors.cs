...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "responseContentError4_additionalErrors")]
    public partial class ResponseContentError4AdditionalErrors : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseContentError4AdditionalErrors" /> class.
        /// </summary>
        /// <param name="description">description.</param>
        public ResponseContentError4AdditionalErrors(string description = default(string))
        {

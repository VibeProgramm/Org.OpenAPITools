...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_cards_update_post_request_inner_dimensions")]
    public partial class ContentV2CardsUpdatePostRequestInnerDimensions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2CardsUpdatePostRequestInnerDimensions" /> class.
        /// </summary>
        /// <param name="length">Длина, см.</param>
        /// <param name="width">Ширина, см.</param>
        /// <param name="height">Высота, см.</param>
        public ContentV2CardsUpdatePostRequestInnerDimensions(int length = default(int), int width = default(int), int height = default(int))
        {
            this.Length = length;
            this.Width = width;
            this.Height = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2CardsUpdatePostRequestInnerDimensions {\n");

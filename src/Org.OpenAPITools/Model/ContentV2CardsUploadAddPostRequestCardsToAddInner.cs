...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_cards_upload_add_post_request_cardsToAdd_inner")]
    public partial class ContentV2CardsUploadAddPostRequestCardsToAddInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2CardsUploadAddPostRequestCardsToAddInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContentV2CardsUploadAddPostRequestCardsToAddInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2CardsUploadAddPostRequestCardsToAddInner" /> class.
        /// </summary>
        ...
        public ContentV2CardsUploadAddPostRequestCardsToAddInner(string brand = default(string), string vendorCode = default(string), string title = default(string), string description = default(string), ContentV2CardsUploadPostRequestInnerVariantsInnerDimensions dimensions = default(ContentV2CardsUploadPostRequestInnerVariantsInnerDimensions), List<ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner> characteristics = default(List<ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner>), List<ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner> sizes = default(List<ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner>))
        {
            // to ensure "vendorCode" is required (not null)
            if (vendorCode == null)
            {
                throw new ArgumentNullException("vendorCode is a required property for ContentV2CardsUploadAddPostRequestCardsToAddInner and cannot be null");
            }
        ...
        public List<ContentV2CardsUploadAddPostRequestCardsToAddInnerCharacteristicsInner> Characteristics { get; set; }
        ...
        public List<ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner> Sizes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2CardsUploadAddPostRequestCardsToAddInner {\n");

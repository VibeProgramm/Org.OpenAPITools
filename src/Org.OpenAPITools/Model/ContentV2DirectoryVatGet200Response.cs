...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_directory_vat_get_200_response")]
    public partial class ContentV2DirectoryVatGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2DirectoryVatGet200Response" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="error">Флаг наличия ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        /// <param name="additionalErrors">Дополнительные ошибки.</param>
        public ContentV2DirectoryVatGet200Response(List<string> data = default(List<string>), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2DirectoryVatGet200Response {\n");

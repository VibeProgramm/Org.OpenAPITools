...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SupplierTaskMetadata : IValidatableObject
    {
        ...
        public SupplierTaskMetadata(int uploadID = default(int), int status = default(int), DateOnly uploadDate = default(DateOnly), DateOnly activationDate = default(DateOnly), int overAllGoodsNumber = default(int), int successGoodsNumber = default(int))
        {
        ...
        */
        ...
        /// </summary>
        /// <value>Статус загрузки:    * &#x60;3&#x60; — обработана, в товарах нет ошибок, цены и скидки обновились   * &#x60;4&#x60; — отменена   * &#x60;5&#x60; — обработана, но в товарах есть ошибки. Для товаров без ошибок цены и скидки обновились, а ошибки в остальных товарах можно получить с помощью метода [Детализация обработанной загрузки](./work-with-products#tag/Ceny-i-skidki/paths/~1api~1v2~1history~1goods~1task/get)   * &#x60;6&#x60; — обработана, но во всех товарах есть ошибки. Их тоже можно получить с помощью метода [Детализация обработанной загрузки](./work-with-products#tag/Ceny-i-skidki/paths/~1api~1v2~1history~1goods~1task/get) </value>
        /*
        <example>3</example>
        */
        ...
        /// Товаров без ошибок
        /// </summary>
        /// <value>Товаров без ошибок</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SupplierTaskMetadata {\n");

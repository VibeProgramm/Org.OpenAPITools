...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_directory_seasons_get_200_response")]
    public partial class ContentV2DirectorySeasonsGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2DirectorySeasonsGet200Response" /> class.
        /// </summary>
        /// <param name="data">Массив значений для хар-ки Сезон.</param>
        ...
        public ContentV2DirectorySeasonsGet200Response(List<string> data = default(List<string>), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        /// </summary>
        /// <value>Массив значений для хар-ки Сезон</value>
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2DirectorySeasonsGet200Response {\n");

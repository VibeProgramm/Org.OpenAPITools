...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_object_all_get_200_response")]
    public partial class ContentV2ObjectAllGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2ObjectAllGet200Response" /> class.
        /// </summary>
        /// <param name="data">Предметы.</param>
        /// <param name="error">Флаг наличия ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        /// <param name="additionalErrors">Дополнительные ошибки.</param>
        public ContentV2ObjectAllGet200Response(List<ContentV2ObjectAllGet200ResponseDataInner> data = default(List<ContentV2ObjectAllGet200ResponseDataInner>), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public List<ContentV2ObjectAllGet200ResponseDataInner> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2ObjectAllGet200Response {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v3_stocks__warehouseId__delete_request")]
    public partial class ApiV3StocksWarehouseIdDeleteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV3StocksWarehouseIdDeleteRequest" /> class.
        /// </summary>
        /// <param name="skus">Массив баркодов.</param>
        public ApiV3StocksWarehouseIdDeleteRequest(List<string> skus = default(List<string>))
        {
            this.Skus = skus;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV3StocksWarehouseIdDeleteRequest {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// Курсор 
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_list_post_request_settings_cursor")]
    public partial class ContentV2GetCardsListPostRequestSettingsCursor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsListPostRequestSettingsCursor" /> class.
        /// </summary>
        /// <param name="limit">Сколько карточек товаров выдать в ответе..</param>
        public ContentV2GetCardsListPostRequestSettingsCursor(int limit = default(int))
        {
            this.Limit = limit;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsListPostRequestSettingsCursor {\n");

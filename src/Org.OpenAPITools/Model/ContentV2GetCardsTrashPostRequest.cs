...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_get_cards_trash_post_request")]
    public partial class ContentV2GetCardsTrashPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2GetCardsTrashPostRequest" /> class.
        /// </summary>
        /// <param name="settings">settings.</param>
        public ContentV2GetCardsTrashPostRequest(ContentV2GetCardsTrashPostRequestSettings settings = default(ContentV2GetCardsTrashPostRequestSettings))
        {
        ...
        public ContentV2GetCardsTrashPostRequestSettings Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2GetCardsTrashPostRequest {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v3_stocks__warehouseId__put_request")]
    public partial class ApiV3StocksWarehouseIdPutRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV3StocksWarehouseIdPutRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV3StocksWarehouseIdPutRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV3StocksWarehouseIdPutRequest" /> class.
        /// </summary>
        /// <param name="stocks">Массив баркодов товаров и их остатков (required).</param>
        public ApiV3StocksWarehouseIdPutRequest(List<ApiV3StocksWarehouseIdPutRequestStocksInner> stocks = default(List<ApiV3StocksWarehouseIdPutRequestStocksInner>))
        {
            // to ensure "stocks" is required (not null)
            if (stocks == null)
            {
                throw new ArgumentNullException("stocks is a required property for ApiV3StocksWarehouseIdPutRequest and cannot be null");
            }
            this.Stocks = stocks;
        }
        ...
        /// </summary>
        /// <value>Массив баркодов товаров и их остатков</value>
        [DataMember(Name = "stocks", IsRequired = true, EmitDefaultValue = true)]
        public List<ApiV3StocksWarehouseIdPutRequestStocksInner> Stocks { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiV3StocksWarehouseIdPutRequest {\n");

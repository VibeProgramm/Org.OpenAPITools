...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_object_charcs__subjectId__get_200_response")]
    public partial class ContentV2ObjectCharcsSubjectIdGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2ObjectCharcsSubjectIdGet200Response" /> class.
        /// </summary>
        /// <param name="data">Данные.</param>
        /// <param name="error">Флаг наличия ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        /// <param name="additionalErrors">Дополнительные ошибки.</param>
        public ContentV2ObjectCharcsSubjectIdGet200Response(List<ContentV2ObjectCharcsSubjectIdGet200ResponseDataInner> data = default(List<ContentV2ObjectCharcsSubjectIdGet200ResponseDataInner>), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public List<ContentV2ObjectCharcsSubjectIdGet200ResponseDataInner> Data { get; set; }

        /// <summary>
        /// Флаг наличия ошибки
        /// </summary>
        /// <value>Флаг наличия ошибки</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2ObjectCharcsSubjectIdGet200Response {\n");

...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_directory_tnved_get_200_response")]
    public partial class ContentV2DirectoryTnvedGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2DirectoryTnvedGet200Response" /> class.
        /// </summary>
        /// <param name="data">Данные.</param>
        /// <param name="error">Флаг наличия ошибки.</param>
        /// <param name="errorText">Текст ошибки.</param>
        /// <param name="additionalErrors">Дополнительные ошибки.</param>
        public ContentV2DirectoryTnvedGet200Response(List<ContentV2DirectoryTnvedGet200ResponseDataInner> data = default(List<ContentV2DirectoryTnvedGet200ResponseDataInner>), bool error = default(bool), string errorText = default(string), string additionalErrors = default(string))
        {
            this.Data = data;
            this.Error = error;
        ...
        public List<ContentV2DirectoryTnvedGet200ResponseDataInner> Data { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2DirectoryTnvedGet200Response {\n");

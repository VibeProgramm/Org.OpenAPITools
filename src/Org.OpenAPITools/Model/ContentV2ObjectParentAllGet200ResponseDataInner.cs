...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_content_v2_object_parent_all_get_200_response_data_inner")]
    public partial class ContentV2ObjectParentAllGet200ResponseDataInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentV2ObjectParentAllGet200ResponseDataInner" /> class.
        /// </summary>
        /// <param name="name">Название категории.</param>
        /// <param name="id">ID родительской категории.</param>
        /// <param name="isVisible">Виден на сайте.</param>
        public ContentV2ObjectParentAllGet200ResponseDataInner(string name = default(string), int id = default(int), bool isVisible = default(bool))
        {
            this.Name = name;
            this.Id = id;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentV2ObjectParentAllGet200ResponseDataInner {\n");
